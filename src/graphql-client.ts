...
export type GetUserAcceptReportsInput = {
  userId: Scalars['Int']['input'];
};
...
export type InterviewReminderEntryItem = {
  ...
  /** 求人情報（企業情報含む） */
  job: JobWithCompanyType;
  /** リマインドステータス (same_day | previous_day | post_interview) */
...
export type Query = {
  ...
  getUserAcceptReports: Array<UserAcceptReportType>;
...
export type QueryGetUserAcceptReportsArgs = {
  input: GetUserAcceptReportsInput;
};
...
export type UserAcceptReportType = {
  __typename?: 'UserAcceptReportType';
...
export type GetScoutsForAdminQuery = { __typename?: 'Query', scoutsForAdmin: { __typename?: 'ScoutsForAdminResultType', totalCount: number, totalPages: number, scouts: Array<{ __typename?: 'ScoutForAdminType', id: number, userId: number, companyId: number, jobId?: number | null, title: string, content: string, status: string, acceptedAt?: any | null, createdAt: any, updatedAt: any, user?: { __typename?: 'ScoutUserType', id: number, name: string, avatarUrl?: string | null } | null, company?: { __typename?: 'ScoutCompanyType', id: number, name: string, industry?: string | null } | null, job?: { __typename?: 'ScoutJobType', id: number, title: string, jobType?: string | null } | null }> } };
...
export type GetScoutsStatisticsQuery = { __typename?: 'Query', scoutsStatistics: { __typename?: 'ScoutsStatisticsType', totalScoutCount: number, acceptedCount: number } };
...
export type GetEntriesStatisticsQuery = { __typename?: 'Query', getEntriesStatistics: { __typename?: 'EntriesStatisticsResultType', totalCount: number, pendingCount: number, reviewingCount: number, interviewCount: number, secondInterviewScheduledCount: number, offeredCount: number, acceptedCount: number, rejectedCount: number } };
...
export type UpdateHotJobsMutation = { __typename?: 'Mutation', updateHotJobs: { __typename: 'HotJobType' } };
...
export type GetUserQuery = { __typename?: 'Query', user?: { __typename?: 'UserType', id: number, lastName?: string | null, firstName?: string | null, avatarUrl?: string | null, university?: string | null, faculty?: string | null, department?: string | null, gender?: string | null, birthDate?: any | null, prefecture?: string | null, email: string, phoneNumber?: string | null, grade?: string | null, graduationYear?: number | null, availableDaysPerWeek?: number | null, availableHoursPerWeek?: number | null, availableDurationMonths?: number | null, interestedIndustries: Array<string>, interestedJobTypes: Array<string>, selfPR?: string | null, futureGoals?: string | null } | null };


export const GetScoutsForAdminDocument = gql`
    query GetScoutsForAdmin($filter: ScoutFilterInput, $page: Float, $limit: Float) {
 ...
 * });
 */
export function useGetScoutsForAdminQuery(baseOptions?: Apollo.QueryHookOptions<GetScoutsForAdminQuery, GetScoutsForAdminQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetScoutsForAdminQuery, GetScoutsForAdminQueryVariables>(GetScoutsForAdminDocument, options);
      }
export function useGetScoutsForAdminLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetScoutsForAdminQuery, GetScoutsForAdminQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetScoutsForAdminQuery, GetScoutsForAdminQueryVariables>(GetScoutsForAdminDocument, options);
        }
export function useGetScoutsForAdminSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetScoutsForAdminQuery, GetScoutsForAdminQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetScoutsForAdminQuery, GetScoutsForAdminQueryVariables>(GetScoutsForAdminDocument, options);
        }
export type GetScoutsForAdminQueryHookResult = ReturnType<typeof useGetScoutsForAdminQuery>;
export type GetScoutsForAdminLazyQueryHookResult = ReturnType<typeof useGetScoutsForAdminLazyQuery>;
export type GetScoutsForAdminSuspenseQueryHookResult = ReturnType<typeof useGetScoutsForAdminSuspenseQuery>;
export type GetScoutsForAdminQueryResult = Apollo.QueryResult<GetScoutsForAdminQuery, GetScoutsForAdminQueryVariables>;
 ...
 * });
 */
export function useGetScoutsStatisticsQuery(baseOptions?: Apollo.QueryHookOptions<GetScoutsStatisticsQuery, GetScoutsStatisticsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetScoutsStatisticsQuery, GetScoutsStatisticsQueryVariables>(GetScoutsStatisticsDocument, options);
      }
export function useGetScoutsStatisticsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetScoutsStatisticsQuery, GetScoutsStatisticsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetScoutsStatisticsQuery, GetScoutsStatisticsQueryVariables>(GetScoutsStatisticsDocument, options);
        }
export function useGetScoutsStatisticsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetScoutsStatisticsQuery, GetScoutsStatisticsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetScoutsStatisticsQuery, GetScoutsStatisticsQueryVariables>(GetScoutsStatisticsDocument, options);
        }
export type GetScoutsStatisticsQueryHookResult = ReturnType<typeof useGetScoutsStatisticsQuery>;
export type GetScoutsStatisticsLazyQueryHookResult = ReturnType<typeof useGetScoutsStatisticsLazyQuery>;
export type GetScoutsStatisticsSuspenseQueryHookResult = ReturnType<typeof useGetScoutsStatisticsSuspenseQuery>;
export type GetScoutsStatisticsQueryResult = Apollo.QueryResult<GetScoutsStatisticsQuery, GetScoutsStatisticsQueryVariables>;
...
export const UpdateHotJobsDocument = gql`
  ...
  updateHotJobs(input: $input) {
    ...
    `;
export type UpdateHotJobsMutationFn = Apollo.MutationFunction<UpdateHotJobsMutation, UpdateHotJobsMutationVariables>;
 ...
 * });
 */
export function useUpdateHotJobsMutation(baseOptions?: Apollo.MutationHookOptions<UpdateHotJobsMutation, UpdateHotJobsMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateHotJobsMutation, UpdateHotJobsMutationVariables>(UpdateHotJobsDocument, options);
      }
export type UpdateHotJobsMutationHookResult = ReturnType<typeof useUpdateHotJobsMutation>;
export type UpdateHotJobsMutationResult = Apollo.MutationResult<UpdateHotJobsMutation>;
export type UpdateHotJobsMutationOptions = Apollo.BaseMutationOptions<UpdateHotJobsMutation, UpdateHotJobsMutationVariables>;
 ...
 * });
 */
export function useGetJobsByHotListQuery(baseOptions?: Apollo.QueryHookOptions<GetJobsByHotListQuery, GetJobsByHotListQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetJobsByHotListQuery, GetJobsByHotListQueryVariables>(GetJobsByHotListDocument, options);
      }
export function useGetJobsByHotListLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetJobsByHotListQuery, GetJobsByHotListQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetJobsByHotListQuery, GetJobsByHotListQueryVariables>(GetJobsByHotListDocument, options);
        }
export function useGetJobsByHotListSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetJobsByHotListQuery, GetJobsByHotListQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetJobsByHotListQuery, GetJobsByHotListQueryVariables>(GetJobsByHotListDocument, options);
        }
export type GetJobsByHotListQueryHookResult = ReturnType<typeof useGetJobsByHotListQuery>;
 ...
 * });
 */
export function useGetAdminMessagesQuery(baseOptions: Apollo.QueryHookOptions<GetAdminMessagesQuery, GetAdminMessagesQueryVariables> & ({ variables: GetAdminMessagesQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetAdminMessagesQuery, GetAdminMessagesQueryVariables>(GetAdminMessagesDocument, options);
      }
export function useGetAdminMessagesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAdminMessagesQuery, GetAdminMessagesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetAdminMessagesQuery, GetAdminMessagesQueryVariables>(GetAdminMessagesDocument, options);
        }
export function useGetAdminMessagesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetAdminMessagesQuery, GetAdminMessagesQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetAdminMessagesQuery, GetAdminMessagesQueryVariables>(GetAdminMessagesDocument, options);
        }
export type GetAdminMessagesQueryHookResult = ReturnType<typeof useGetAdminMessagesQuery>;
